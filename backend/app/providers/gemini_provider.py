...
3. 补强维度（只补这些，不擅自改变风格）：
   - 服装细节：款式、面料、质感（如用户只写"女生"，可根据参考图或合理推断补"短款皮夹克+阔腿裤"）
   - 光影氛围：光线方向、色温、硬度（如硬光逆光勾边 / 柔和窗光 / 黄金时刻侧光）
   - 场景细节：把抽象场景具体化（如"十字路口"→"阳光斑驳的十字路口斑马线"）
   - 动作细节：起止姿态、中间过程（如"转身"→"转身扬起外套下摆"）
...
示例输出："5秒竖屏卡点街拍视频，鱼眼圆框广角镜头，手持轻微晃动。女生身穿黑色短款皮夹克配高腰阔腿裤，第一帧中景定格，镜头瞬间极速推近至面部特写；卡点跳切，女生快速转身扬起外套下摆，鱼眼畸变在转身瞬间达到峰值；末帧定格半身姿态，硬光逆光勾边。全程运镜快准稳，鱼眼畸变明显，快节奏动态冲击力，时尚街拍感。"

示例输入："优雅转身，5秒，红色长裙"
示例输出："5秒时尚展示视频，黄金时刻柔和侧光。模特身穿红色飘逸长裙，开场背对镜头中景定格，缓慢旋转180度，裙摆随转身自然扬起荡出弧线，红色面料在光线下泛出丝缎光泽；镜头随转身同步横移跟拍，末帧停在三七面近景，模特完成转身后微微一笑定格。整体优雅从容，裙摆流动感是视觉焦点。"""
